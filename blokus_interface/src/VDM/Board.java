    ...
    try {
      ...
      while ( new Boolean((i.intValue()) <= (new Integer(coordsInBoard.size()).intValue())).booleanValue()){
        ...
        if (new Boolean(UTIL.equals(b, new Boolean(true))).booleanValue()) 
          return b;
        Vector rhs_13 = null;
        Piece.Coord e_seq_14 = null;
        Double tmpVar_15 = null;
        Double var1_16 = null;
        Piece.Coord tmpRec_17 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_17 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_16 = (tmpRec_17).x;
        tmpVar_15 = new Double(var1_16.doubleValue() - new Integer(1).intValue());
        Double tmpVar_21 = null;
        Double var1_22 = null;
        Piece.Coord tmpRec_23 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_23 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_22 = (tmpRec_23).y;
        tmpVar_21 = new Double(var1_22.doubleValue() - new Integer(1).intValue());
        e_seq_14 = new Piece.Coord(tmpVar_15, tmpVar_21);
        rhs_13 = new Vector();
        rhs_13.add(e_seq_14);
        Piece.Coord e_seq_27 = null;
        Double tmpVar_28 = null;
        Double var1_29 = null;
        Piece.Coord tmpRec_30 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_30 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_29 = (tmpRec_30).x;
        tmpVar_28 = new Double(var1_29.doubleValue() + new Integer(1).intValue());
        Double tmpVar_34 = null;
        Double var1_35 = null;
        Piece.Coord tmpRec_36 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_36 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_35 = (tmpRec_36).y;
        tmpVar_34 = new Double(var1_35.doubleValue() - new Integer(1).intValue());
        e_seq_27 = new Piece.Coord(tmpVar_28, tmpVar_34);
        rhs_13.add(e_seq_27);
        Piece.Coord e_seq_40 = null;
        Double tmpVar_41 = null;
        Double var1_42 = null;
        Piece.Coord tmpRec_43 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_43 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_42 = (tmpRec_43).x;
        tmpVar_41 = new Double(var1_42.doubleValue() + new Integer(1).intValue());
        Double tmpVar_47 = null;
        Double var1_48 = null;
        Piece.Coord tmpRec_49 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_49 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_48 = (tmpRec_49).y;
        tmpVar_47 = new Double(var1_48.doubleValue() + new Integer(1).intValue());
        e_seq_40 = new Piece.Coord(tmpVar_41, tmpVar_47);
        rhs_13.add(e_seq_40);
        Piece.Coord e_seq_53 = null;
        Double tmpVar_54 = null;
        Double var1_55 = null;
        Piece.Coord tmpRec_56 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_56 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_55 = (tmpRec_56).x;
        tmpVar_54 = new Double(var1_55.doubleValue() - new Integer(1).intValue());
        Double tmpVar_60 = null;
        Double var1_61 = null;
        Piece.Coord tmpRec_62 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= coordsInBoard.size())) 
          tmpRec_62 = (Piece.Coord) coordsInBoard.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        var1_61 = (tmpRec_62).y;
        tmpVar_60 = new Double(var1_61.doubleValue() + new Integer(1).intValue());
        e_seq_53 = new Piece.Coord(tmpVar_54, tmpVar_60);
        rhs_13.add(e_seq_53);
        corners = (Vector) UTIL.ConvertToList(UTIL.clone(rhs_13));
        while ( new Boolean((j.intValue()) <= (new Integer(4).intValue())).booleanValue()){

          Boolean cond_69 = null;
          Boolean var1_70 = null;
          Boolean var1_71 = null;
          Boolean var1_72 = null;
          Double var1_73 = null;
          Piece.Coord tmpRec_74 = null;
          if ((1 <= j.intValue()) && (j.intValue() <= corners.size())) 
            tmpRec_74 = (Piece.Coord) corners.get(j.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
          var1_73 = (tmpRec_74).x;
          var1_72 = new Boolean((var1_73.doubleValue()) > (new Integer(0).intValue()));
          {
            if ((var1_71 = var1_72).booleanValue()) {

              Boolean var2_78 = null;
              Double var1_79 = null;
              Piece.Coord tmpRec_80 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= corners.size())) 
                tmpRec_80 = (Piece.Coord) corners.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_79 = (tmpRec_80).x;
              var2_78 = new Boolean((var1_79.doubleValue()) <= (new Integer(20).intValue()));
              var1_71 = var2_78;
            }
          }
          {
            if ((var1_70 = var1_71).booleanValue()) {

              Boolean var2_84 = null;
              Double var1_85 = null;
              Piece.Coord tmpRec_86 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= corners.size())) 
                tmpRec_86 = (Piece.Coord) corners.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_85 = (tmpRec_86).y;
              var2_84 = new Boolean((var1_85.doubleValue()) > (new Integer(0).intValue()));
              var1_70 = var2_84;
            }
          }
          {
            if ((cond_69 = var1_70).booleanValue()) {

              Boolean var2_90 = null;
              Double var1_91 = null;
              Piece.Coord tmpRec_92 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= corners.size())) 
                tmpRec_92 = (Piece.Coord) corners.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_91 = (tmpRec_92).y;
              var2_90 = new Boolean((var1_91.doubleValue()) <= (new Integer(20).intValue()));
              cond_69 = var2_90;
            }
          }
          if (cond_69.booleanValue()) {

            Boolean cond_96 = null;
            Piece.Coord par_97 = null;
            if ((1 <= j.intValue()) && (j.intValue() <= corners.size())) 
              par_97 = (Piece.Coord) corners.get(j.intValue() - 1);
            else 
              UTIL.RunTime("Run-Time Error:Illegal index");
            cond_96 = validCorner(par_97, coordsInBoard);
            if (cond_96.booleanValue()) {

              Boolean cond_101 = null;
              Object var1_102 = null;
              Piece.Coord tmppar_104 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= corners.size())) 
                tmppar_104 = (Piece.Coord) corners.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_102 = board.get(tmppar_104);
              Object var2_107 = null;
              var2_107 = piece.getColor();
              cond_101 = new Boolean(UTIL.equals(var1_102, var2_107));
              if (cond_101.booleanValue()) 
                b = (Boolean) UTIL.clone(new Boolean(true));
            }
          }
          j = UTIL.NumberToInt(UTIL.clone(new Integer(j.intValue() + new Integer(1).intValue())));
        }
        j = UTIL.NumberToInt(UTIL.clone(new Integer(1)));
        i = UTIL.NumberToInt(UTIL.clone(new Integer(i.intValue() + new Integer(1).intValue())));
      }
      return b;
    }
    ...
    try {
      ...
      while ( new Boolean((i.intValue()) <= (new Integer(coordsInBoard.size()).intValue())).booleanValue()){
        ...
        while ( new Boolean((j.intValue()) <= (new Integer(4).intValue())).booleanValue()){
          ...
          Boolean var1_59 = null;
          Boolean var1_60 = null;
          Double var1_61 = null;
          Piece.Coord tmpRec_62 = null;
          if ((1 <= j.intValue()) && (j.intValue() <= sides.size())) 
            tmpRec_62 = (Piece.Coord) sides.get(j.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
          var1_61 = (tmpRec_62).x;
          var1_60 = new Boolean((var1_61.doubleValue()) > (new Integer(0).intValue()));
          {
            if ((var1_59 = var1_60).booleanValue()) {

              Boolean var2_66 = null;
              Double var1_67 = null;
              Piece.Coord tmpRec_68 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= sides.size())) 
                tmpRec_68 = (Piece.Coord) sides.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_67 = (tmpRec_68).x;
              var2_66 = new Boolean((var1_67.doubleValue()) <= (new Integer(20).intValue()));
              var1_59 = var2_66;
            }
          }
          {
            if ((var1_58 = var1_59).booleanValue()) {

              Boolean var2_72 = null;
              Double var1_73 = null;
              Piece.Coord tmpRec_74 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= sides.size())) 
                tmpRec_74 = (Piece.Coord) sides.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_73 = (tmpRec_74).y;
              var2_72 = new Boolean((var1_73.doubleValue()) > (new Integer(0).intValue()));
              var1_58 = var2_72;
            }
          }
          {
            if ((cond_57 = var1_58).booleanValue()) {
              ...
              Piece.Coord tmpRec_80 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= sides.size())) 
                tmpRec_80 = (Piece.Coord) sides.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_79 = (tmpRec_80).y;
              var2_78 = new Boolean((var1_79.doubleValue()) <= (new Integer(20).intValue()));
          ...
          if (cond_57.booleanValue()) {
            ...
            Piece.Coord var1_85 = null;
            if ((1 <= j.intValue()) && (j.intValue() <= sides.size())) 
              var1_85 = (Piece.Coord) sides.get(j.intValue() - 1);
            else 
              UTIL.RunTime("Run-Time Error:Illegal index");
            HashSet var2_88 = new HashSet();
            HashSet set_90 = new HashSet();
            Enumeration enm_91 = coordsInBoard.elements();
            while ( enm_91.hasMoreElements())
              set_90.add(enm_91.nextElement());
            var2_88 = set_90;
            cond_84 = new Boolean(!var2_88.contains(var1_85));
            if (cond_84.booleanValue()) {

              Boolean cond_92 = null;
              Object var1_93 = null;
              Piece.Coord tmppar_95 = null;
              if ((1 <= j.intValue()) && (j.intValue() <= sides.size())) 
                tmppar_95 = (Piece.Coord) sides.get(j.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              var1_93 = board.get(tmppar_95);
              Object var2_98 = null;
              var2_98 = piece.getColor();
              cond_92 = new Boolean(UTIL.equals(var1_93, var2_98));

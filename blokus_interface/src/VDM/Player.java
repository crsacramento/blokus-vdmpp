...
// ***** VDMTOOLS START Name=PlayerSentinel KEEP=NO
  class PlayerSentinel extends Sentinel {
    ...
    public final int getCurrentPiece = 8;

    public final int getPlayingPiece = 9;

    public final int isPlayerPlaying = 10;

    public final int toggleIsPlaying = 11;

    public final int wasLastPieceMono = 12;

    public final int getLastPiecePlayed = 13;

    public final int hasPlayedFirstPiece = 14;

    public final int setPlayedFirstPiece = 15;

    public final int updateLastPiecePlayed = 16;
